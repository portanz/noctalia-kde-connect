...
QtObject {
    ...
    function pingDevice(deviceId: string): void {
        const proc = pingComponent.createObject(root, {
            deviceId: deviceId
        });
        proc.running = true;
    }
    ...
    function triggerFindMyPhone(deviceId: string): void {
        const proc = findMyPhoneComponent.createObject(root, {
            deviceId: deviceId
        });
        proc.running = true;
    }
    ...
    function requestPairing(deviceId: string): void {
        const proc = requestPairingComponent.createObject(root, {
            deviceId: deviceId
        });
        proc.running = true;
    }
    ...
    function unpairDevice(deviceId: string): void {
        const proc = unpairingComponent.createObject(root, {
            deviceId: deviceId
        });
        proc.running = true;
    }
